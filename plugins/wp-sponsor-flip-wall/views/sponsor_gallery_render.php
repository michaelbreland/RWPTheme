...
?>
	...
	<?php		echo $sponsor->getDescription() ?>
			...
			<div class="sponsorURL">
				<a href="<?php echo (strpos($sponsor->getLink(), 'http://') !== false) ? $sponsor->getLink() : "http://{$sponsor->getLink()}"; ?>" target="_blank">
...
<script type="text/javascript" src="<?php echo plugins_url('wp-sponsor-flip-wall/js/jquery.ui.js') ?>"></script>
<script type="text/javascript" src="<?php echo plugins_url('wp-sponsor-flip-wall/js/jquery.flip.min.js') ?>"></script>
